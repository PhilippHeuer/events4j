...
dependencies {
    // Project
    api(project(":api"))
    api(group = "org.jetbrains.kotlinx", name = "kotlinx-coroutines-core", version = "1.7.0")

    // Testing
    testImplementation(group = "org.jetbrains.kotlinx", name="kotlinx-coroutines-test", version = "1.7.0")
