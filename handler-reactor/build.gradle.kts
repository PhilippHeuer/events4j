dependencies {
	...
	api(group = "io.projectreactor", name = "reactor-core", version = "3.4.15")
	api(group = "io.projectreactor.addons", name = "reactor-extra", version = "3.4.7")
	testImplementation(group = "io.projectreactor", name = "reactor-test", version = "3.4.15")
}
